...
ld <- qchisq(0.025, df = 24)
lu <- qchisq(1-0.025, df = 24)

P(ld < V < lu) = 95%
12.40115 < V < 39.36408
12.40115 < (n-1)*S²/σ²  < 39.36408

1/39.36408 < σ²/(n-1)*S²  < 1/12.40115
(n-1)*S²/39.36408 < σ² < (n-1)*S²/12.40115

24*20/39.36408 < σ² < 24*20/12.40115
12.19386 < σ² < 38.70609
 
# 2) 검정통계량
#    검정통계량 채택역 : [ld, lu]      # [12.40115, 39.36408]
...
n = 7
S² = var(c(45, 47, 44, 48, 46, 45, 47)) = 2

ld <- qchisq(0.025, df = 6)            # 1.237344
lu <- qchisq(1-0.025, df = 6)          # 14.44938

(n-1)*S²/lu < σ² < (n-1)*S²/ld
(7-1)*2/14.44938 < σ² < (7-1)*2/1.237344
0.8304855 < σ² < 9.698192
